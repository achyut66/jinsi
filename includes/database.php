...
//		}
	...
	if(isset($_SESSION['fiscal_year']) && $_SESSION['fiscal_year'] == 1)
        {
            $database= new MySQlDatabase("localhost","sagarlam_jinsib","bakaiyajinsi78","sagarlam_bakaiya_jinsi");
        }
        elseif(isset($_SESSION['fiscal_year']) && $_SESSION['fiscal_year']==2)
        {
            $database= new MySQlDatabase("localhost","sagarlam_bakaiya79","#bakaiya@79","sagarlam_bakaiya_jinsi_79");
        }
        else
        {
            $database= new MySQlDatabase("localhost","sagarlam_bakaiya79","#bakaiya@79","sagarlam_bakaiya_jinsi_79");
