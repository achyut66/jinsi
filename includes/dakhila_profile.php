...
class Dakhilaprofile
{
	protected static $table_name = "dakhila_profile";
	protected static $db_fields = array('id','date_nepali','date_english',
            'bill_type','item_source','sub_total','vat_total','discount','grand_total','adesh_id');
		public $id;
        public $date_english;
        public $date_nepali;
		public $bill_type;
    ...
    public function getMax_adesh_id()
    {
        global $database;
        ...
        public static function find_by_adesh_id($adesh_id=0)
	{
        ...
        public static function check_adesh($adesh_id=0)
	{
		global $database;
		$result_array = self::find_by_sql("select * from ".self::$table_name. " where adesh_id={$adesh_id} ");
	...
	public static function count_all()
	{
        ...
        {
           $dates = array();
           $sql = "select distinct date_english from ".self::$table_name;
           $result_array = self::find_by_sql($sql);
           foreach($result_array as $date_array)
           {
               array_push($dates, $date_array->date_english);
           }
           return $dates; 
        }
